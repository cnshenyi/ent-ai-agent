...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const APP_VERSION = '3.6.0'; // Update this to force cache clear
            ...
            <div className="flex gap-1.5 sm:gap-2 items-center pb-2">
              {!isListening && !isProcessingSpeech && (
                <button
                  ...
                  className="p-2.5 sm:p-3 rounded-xl transition-all flex-shrink-0 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/50"
                  title="语音输入"
                >
              ...
              {isListening ? (
                <VoiceWaveform isActive={isListening} audioStream={audioStream} onStop={startVoiceInput} />
              ) : isProcessingSpeech ? (
                <div className="flex-1 flex items-center justify-center gap-2 bg-blue-50 dark:bg-gray-700 rounded-xl px-4 border border-blue-200 dark:border-gray-600" style={{ height: '44px' }}>
